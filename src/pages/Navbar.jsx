...
export default function Navbar() {
  ...
  {[
    ...
    <li key={index} className="hover:text-blue-500 transition duration-300 ease-in-out cursor-pointer">
...
>
  ...
  <div
    ...
    style={{ clipPath: "polygon(0 0, 60% 0, 80% 100%, 0% 100%)" }} // 🔹 White Layer Adjusted
  ></div>
